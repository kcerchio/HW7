...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="Sql_cubs" runat="server" ConnectionString="<%$ ConnectionStrings:db_kcerchioCubs %>" 
            ...
            InsertCommand="INSERT INTO [kcerchio_cubs] ([player_name], [player_number], [player_position]) VALUES (@player_name, @player_number, @player_position)" 
            SelectCommand="SELECT [player_name], [player_number], [player_position], [player_ID] FROM [kcerchio_cubs]" 
            UpdateCommand="UPDATE [kcerchio_cubs] SET [player_name] = @player_name, [player_number] = @player_number, [player_position] = @player_position WHERE [player_ID] = @player_ID">
            <DeleteParameters>
